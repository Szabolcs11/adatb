--------------------------------------------------------
--  File created - Monday-May-05-2025   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SYSTEM"."FELHASZNALO_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SYSTEM"."SZOCIKK_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 5 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence SZOCIKK_UPDATED_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."SZOCIKK_UPDATED_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 101 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."FELHASZNALO" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	...
	"REGISZTRACIOS_DATUM" DATE DEFAULT SYSDATE, 
	"ADMIN" NUMBER(1,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."HIBA" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"SZOVEG" CLOB, 
	"JELENTESI_DATUM" DATE DEFAULT SYSDATE, 
	"STATUSZ" VARCHAR2(50 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."KULCSSZO" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"SZO" VARCHAR2(255 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table SZOCIKK
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."SZOCIKK" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"CIM" VARCHAR2(255 BYTE), 
	"LETREHOZAS_DATUM" DATE DEFAULT SYSDATE, 
	"MODOSITAS_DATUM" DATE DEFAULT SYSDATE, 
	"STATUSZ" VARCHAR2(50 BYTE), 
	"SZERZO_ID" NUMBER, 
	"TARTALOM" VARCHAR2(255 BYTE), 
	"KEP_BINARIS" BLOB, 
	"NYELV" VARCHAR2(50 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" 
 LOB ("KEP_BINARIS") STORE AS BASICFILE (
  TABLESPACE "SYSTEM" ENABLE STORAGE IN ROW 4000 CHUNK 8192 RETENTION 
  NOCACHE LOGGING 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) ;
--------------------------------------------------------
--  DDL for Table SZOCIKKKATEGORIA
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."SZOCIKKKATEGORIA" 
   (	"SZOCIKK_ID" NUMBER, 
	"KATEGORIA_ID" NUMBER
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table SZOCIKKKULCSSZO
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."SZOCIKKKULCSSZO" 
   (	"SZOCIKK_ID" NUMBER, 
	"KULCSSZO_ID" NUMBER
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table SZOCIKKLEKTOR
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."SZOCIKKLEKTOR" 
   (	"SZOCIKK_ID" NUMBER, 
	"LEKTOR_ID" NUMBER
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table SZOCIKKTEMAKOR
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."SZOCIKKTEMAKOR" 
   (	"SZOCIKK_ID" NUMBER, 
	"TEMAKOR_ID" NUMBER
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
...
Insert into SYSTEM.FELHASZNALO (ID,NEV,EMAIL,JELSZO,REGISZTRACIOS_DATUM,ADMIN) values (41,'Kiss Péter','peter.kiss@example.com','jelszo123',to_date('26-APR-25','DD-MON-RR'),0);
Insert into SYSTEM.FELHASZNALO (ID,NEV,EMAIL,JELSZO,REGISZTRACIOS_DATUM,ADMIN) values (42,'Nagy Anna','anna.nagy@example.com','titkos123',to_date('26-APR-25','DD-MON-RR'),0);
Insert into SYSTEM.FELHASZNALO (ID,NEV,EMAIL,JELSZO,REGISZTRACIOS_DATUM,ADMIN) values (43,'Szabó László','laszlo.szabo@example.com','pass456',to_date('26-APR-25','DD-MON-RR'),0);
Insert into SYSTEM.FELHASZNALO (ID,NEV,EMAIL,JELSZO,REGISZTRACIOS_DATUM,ADMIN) values (61,'a','av@a.com','a',to_date('26-APR-25','DD-MON-RR'),0);
Insert into SYSTEM.FELHASZNALO (ID,NEV,EMAIL,JELSZO,REGISZTRACIOS_DATUM,ADMIN) values (45,'Varga Zoltánasd','zoltan.varga@example.com','mypassword',to_date('26-APR-25','DD-MON-RR'),0);
Insert into SYSTEM.FELHASZNALO (ID,NEV,EMAIL,JELSZO,REGISZTRACIOS_DATUM,ADMIN) values (63,'k','k@k.com','kk',to_date('26-APR-25','DD-MON-RR'),0);
...
SET DEFINE OFF;
Insert into SYSTEM.HIBA (ID,JELENTESI_DATUM,STATUSZ,FELHASZNALO_ID,SZOCIKK_ID) values (2,to_date('23-MAR-25','DD-MON-RR'),'Feldolgozás alatt',2,2);
Insert into SYSTEM.HIBA (ID,JELENTESI_DATUM,STATUSZ,FELHASZNALO_ID,SZOCIKK_ID) values (3,to_date('23-MAR-25','DD-MON-RR'),'Javított',3,3);
Insert into SYSTEM.HIBA (ID,JELENTESI_DATUM,STATUSZ,FELHASZNALO_ID,SZOCIKK_ID) values (4,to_date('23-MAR-25','DD-MON-RR'),'Nyitott',4,4);
Insert into SYSTEM.HIBA (ID,JELENTESI_DATUM,STATUSZ,FELHASZNALO_ID,SZOCIKK_ID) values (5,to_date('23-MAR-25','DD-MON-RR'),'Feldolgozás alatt',5,5);
Insert into SYSTEM.HIBA (ID,JELENTESI_DATUM,STATUSZ,FELHASZNALO_ID,SZOCIKK_ID) values (21,to_date('22-APR-25','DD-MON-RR'),'Nyitott',21,2);
Insert into SYSTEM.HIBA (ID,JELENTESI_DATUM,STATUSZ,FELHASZNALO_ID,SZOCIKK_ID) values (22,to_date('22-APR-25','DD-MON-RR'),'Nyitott',21,2);
Insert into SYSTEM.HIBA (ID,JELENTESI_DATUM,STATUSZ,FELHASZNALO_ID,SZOCIKK_ID) values (23,to_date('22-APR-25','DD-MON-RR'),'Nyitott',21,4);
Insert into SYSTEM.HIBA (ID,JELENTESI_DATUM,STATUSZ,FELHASZNALO_ID,SZOCIKK_ID) values (24,to_date('22-APR-25','DD-MON-RR'),'Nyitott',21,1);
Insert into SYSTEM.HIBA (ID,JELENTESI_DATUM,STATUSZ,FELHASZNALO_ID,SZOCIKK_ID) values (41,to_date('26-APR-25','DD-MON-RR'),'Nyitott',21,2);
Insert into SYSTEM.HIBA (ID,JELENTESI_DATUM,STATUSZ,FELHASZNALO_ID,SZOCIKK_ID) values (42,to_date('26-APR-25','DD-MON-RR'),'Új',1,1);
Insert into SYSTEM.HIBA (ID,JELENTESI_DATUM,STATUSZ,FELHASZNALO_ID,SZOCIKK_ID) values (43,to_date('26-APR-25','DD-MON-RR'),'Kezelés alatt',2,2);
Insert into SYSTEM.HIBA (ID,JELENTESI_DATUM,STATUSZ,FELHASZNALO_ID,SZOCIKK_ID) values (44,to_date('26-APR-25','DD-MON-RR'),'Javítva',3,3);
Insert into SYSTEM.HIBA (ID,JELENTESI_DATUM,STATUSZ,FELHASZNALO_ID,SZOCIKK_ID) values (45,to_date('26-APR-25','DD-MON-RR'),'Új',4,4);
Insert into SYSTEM.HIBA (ID,JELENTESI_DATUM,STATUSZ,FELHASZNALO_ID,SZOCIKK_ID) values (46,to_date('26-APR-25','DD-MON-RR'),'Kezelés alatt',5,5);
Insert into SYSTEM.HIBA (ID,JELENTESI_DATUM,STATUSZ,FELHASZNALO_ID,SZOCIKK_ID) values (61,to_date('26-APR-25','DD-MON-RR'),'Nyitott',21,25);
Insert into SYSTEM.HIBA (ID,JELENTESI_DATUM,STATUSZ,FELHASZNALO_ID,SZOCIKK_ID) values (81,to_date('04-MAY-25','DD-MON-RR'),'Nyitott',21,2);
Insert into SYSTEM.HIBA (ID,JELENTESI_DATUM,STATUSZ,FELHASZNALO_ID,SZOCIKK_ID) values (82,to_date('04-MAY-25','DD-MON-RR'),'Nyitott',21,42);
REM INSERTING into SYSTEM.KATEGORIA
SET DEFINE OFF;
Insert into SYSTEM.KATEGORIA (ID,NEV) values (1,'Tudomány');
Insert into SYSTEM.KATEGORIA (ID,NEV) values (2,'Kultúra');
...
Insert into SYSTEM.LEKTOR (ID,TUDOMANYOS_FOKOZAT,INTEZET,SZAKTERULET) values (2,'MSc','ELTE','Számítógépes rendszerek');
Insert into SYSTEM.LEKTOR (ID,TUDOMANYOS_FOKOZAT,INTEZET,SZAKTERULET) values (3,'PhD','SZTE','Szoftverfejlesztés');
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.SZOCIKK
SET DEFINE OFF;
Insert into SYSTEM.SZOCIKK (ID,CIM,LETREHOZAS_DATUM,MODOSITAS_DATUM,STATUSZ,SZERZO_ID,TARTALOM,NYELV) values (1,'SQL Alapok',to_date('23-MAR-25','DD-MON-RR'),to_date('03-MAY-25','DD-MON-RR'),'Lektorálásra vár',1,'Bevezetes az SQL vilagaba.','magyar');
Insert into SYSTEM.SZOCIKK (ID,CIM,LETREHOZAS_DATUM,MODOSITAS_DATUM,STATUSZ,SZERZO_ID,TARTALOM,NYELV) values (2,'Adatbázis Normalizálás',to_date('23-MAR-25','DD-MON-RR'),to_date('03-MAY-25','DD-MON-RR'),'Lektorálásra vár',2,'Az adatbázis normalizálás szintjei.','magyar');
...
Insert into SYSTEM.SZOCIKK (ID,CIM,LETREHOZAS_DATUM,MODOSITAS_DATUM,STATUSZ,SZERZO_ID,TARTALOM,NYELV) values (4,'Oracle Triggerek',to_date('23-MAR-25','DD-MON-RR'),to_date('04-MAY-25','DD-MON-RR'),'Lektorálásra vár',4,'A triggerek használata Oracle adatbázisban.','magyar');
...
Insert into SYSTEM.SZOCIKK (ID,CIM,LETREHOZAS_DATUM,MODOSITAS_DATUM,STATUSZ,SZERZO_ID,TARTALOM,NYELV) values (84,'Új magyar szócikk',to_date('04-MAY-25','DD-MON-RR'),to_date('05-MAY-25','DD-MON-RR'),'Lektorálásra vár',1,'magyar tartalom2','magyar');
...
Insert into SYSTEM.SZOCIKKKATEGORIA (SZOCIKK_ID,KATEGORIA_ID) values (2,2);
Insert into SYSTEM.SZOCIKKKATEGORIA (SZOCIKK_ID,KATEGORIA_ID) values (3,1);
Insert into SYSTEM.SZOCIKKKATEGORIA (SZOCIKK_ID,KATEGORIA_ID) values (3,3);
Insert into SYSTEM.SZOCIKKKATEGORIA (SZOCIKK_ID,KATEGORIA_ID) values (3,4);
Insert into SYSTEM.SZOCIKKKATEGORIA (SZOCIKK_ID,KATEGORIA_ID) values (4,1);
Insert into SYSTEM.SZOCIKKKATEGORIA (SZOCIKK_ID,KATEGORIA_ID) values (4,4);
...
Insert into SYSTEM.SZOCIKKKULCSSZO (SZOCIKK_ID,KULCSSZO_ID) values (1,2);
Insert into SYSTEM.SZOCIKKKULCSSZO (SZOCIKK_ID,KULCSSZO_ID) values (2,2);
Insert into SYSTEM.SZOCIKKKULCSSZO (SZOCIKK_ID,KULCSSZO_ID) values (2,3);
Insert into SYSTEM.SZOCIKKKULCSSZO (SZOCIKK_ID,KULCSSZO_ID) values (3,1);
Insert into SYSTEM.SZOCIKKKULCSSZO (SZOCIKK_ID,KULCSSZO_ID) values (3,3);
Insert into SYSTEM.SZOCIKKKULCSSZO (SZOCIKK_ID,KULCSSZO_ID) values (3,4);
...
Insert into SYSTEM.SZOCIKKLEKTOR (SZOCIKK_ID,LEKTOR_ID) values (2,2);
Insert into SYSTEM.SZOCIKKLEKTOR (SZOCIKK_ID,LEKTOR_ID) values (3,3);
Insert into SYSTEM.SZOCIKKLEKTOR (SZOCIKK_ID,LEKTOR_ID) values (4,4);
Insert into SYSTEM.SZOCIKKLEKTOR (SZOCIKK_ID,LEKTOR_ID) values (5,5);
REM INSERTING into SYSTEM.SZOCIKKTEMAKOR
SET DEFINE OFF;
...
Insert into SYSTEM.SZOCIKKTEMAKOR (SZOCIKK_ID,TEMAKOR_ID) values (4,21);
...
Insert into SYSTEM.SZOCIKKTEMAKOR (SZOCIKK_ID,TEMAKOR_ID) values (84,21);
...
Insert into SYSTEM.SZOCIKK_UPDATED (ID,SZOCIKKID,UJTARTALOM,MODOSITASDATUM) values (21,1,'Bevezetes az SQL vilagaba.',to_date('03-MAY-25','DD-MON-RR'));
Insert into SYSTEM.SZOCIKK_UPDATED (ID,SZOCIKKID,UJTARTALOM,MODOSITASDATUM) values (22,2,'Az adatbázis normalizálás szintjei.',to_date('03-MAY-25','DD-MON-RR'));
Insert into SYSTEM.SZOCIKK_UPDATED (ID,SZOCIKKID,UJTARTALOM,MODOSITASDATUM) values (23,3,'Hogyan gyorsíthatók le a lekérdezések indexekkel?',to_date('03-MAY-25','DD-MON-RR'));
Insert into SYSTEM.SZOCIKK_UPDATED (ID,SZOCIKKID,UJTARTALOM,MODOSITASDATUM) values (24,4,'A triggerek használata Oracle adatbázisban.',to_date('03-MAY-25','DD-MON-RR'));
Insert into SYSTEM.SZOCIKK_UPDATED (ID,SZOCIKKID,UJTARTALOM,MODOSITASDATUM) values (25,5,'A PL/SQL tárolt eljárások bemutatása.',to_date('03-MAY-25','DD-MON-RR'));
Insert into SYSTEM.SZOCIKK_UPDATED (ID,SZOCIKKID,UJTARTALOM,MODOSITASDATUM) values (26,21,'Ez egy cikk a technológiai fejlődésről.',to_date('03-MAY-25','DD-MON-RR'));
Insert into SYSTEM.SZOCIKK_UPDATED (ID,SZOCIKKID,UJTARTALOM,MODOSITASDATUM) values (27,22,'A művészet hatása a társadalomra.',to_date('03-MAY-25','DD-MON-RR'));
Insert into SYSTEM.SZOCIKK_UPDATED (ID,SZOCIKKID,UJTARTALOM,MODOSITASDATUM) values (28,23,'A sejtek szerkezete és működése.',to_date('03-MAY-25','DD-MON-RR'));
Insert into SYSTEM.SZOCIKK_UPDATED (ID,SZOCIKKID,UJTARTALOM,MODOSITASDATUM) values (29,24,'Newton törvényeinek áttekintése.',to_date('03-MAY-25','DD-MON-RR'));
Insert into SYSTEM.SZOCIKK_UPDATED (ID,SZOCIKKID,UJTARTALOM,MODOSITASDATUM) values (30,25,'A középkori uralkodók élete.',to_date('03-MAY-25','DD-MON-RR'));
Insert into SYSTEM.SZOCIKK_UPDATED (ID,SZOCIKKID,UJTARTALOM,MODOSITASDATUM) values (31,42,'polgi',to_date('03-MAY-25','DD-MON-RR'));
Insert into SYSTEM.SZOCIKK_UPDATED (ID,SZOCIKKID,UJTARTALOM,MODOSITASDATUM) values (32,44,'dsfhdsfhsdfh381',to_date('03-MAY-25','DD-MON-RR'));
Insert into SYSTEM.SZOCIKK_UPDATED (ID,SZOCIKKID,UJTARTALOM,MODOSITASDATUM) values (33,62,'far',to_date('03-MAY-25','DD-MON-RR'));
Insert into SYSTEM.SZOCIKK_UPDATED (ID,SZOCIKKID,UJTARTALOM,MODOSITASDATUM) values (41,62,'far',to_date('03-MAY-25','DD-MON-RR'));
Insert into SYSTEM.SZOCIKK_UPDATED (ID,SZOCIKKID,UJTARTALOM,MODOSITASDATUM) values (42,62,'far',to_date('03-MAY-25','DD-MON-RR'));
Insert into SYSTEM.SZOCIKK_UPDATED (ID,SZOCIKKID,UJTARTALOM,MODOSITASDATUM) values (43,62,'far',to_date('03-MAY-25','DD-MON-RR'));
Insert into SYSTEM.SZOCIKK_UPDATED (ID,SZOCIKKID,UJTARTALOM,MODOSITASDATUM) values (44,62,'far',to_date('03-MAY-25','DD-MON-RR'));
Insert into SYSTEM.SZOCIKK_UPDATED (ID,SZOCIKKID,UJTARTALOM,MODOSITASDATUM) values (45,44,'dsfhdsfhsdfh381',to_date('03-MAY-25','DD-MON-RR'));
Insert into SYSTEM.SZOCIKK_UPDATED (ID,SZOCIKKID,UJTARTALOM,MODOSITASDATUM) values (46,62,'far',to_date('03-MAY-25','DD-MON-RR'));
Insert into SYSTEM.SZOCIKK_UPDATED (ID,SZOCIKKID,UJTARTALOM,MODOSITASDATUM) values (47,62,'far',to_date('03-MAY-25','DD-MON-RR'));
Insert into SYSTEM.SZOCIKK_UPDATED (ID,SZOCIKKID,UJTARTALOM,MODOSITASDATUM) values (48,62,'far',to_date('03-MAY-25','DD-MON-RR'));
Insert into SYSTEM.SZOCIKK_UPDATED (ID,SZOCIKKID,UJTARTALOM,MODOSITASDATUM) values (49,44,'dsfhdsfhsdfh381',to_date('03-MAY-25','DD-MON-RR'));
Insert into SYSTEM.SZOCIKK_UPDATED (ID,SZOCIKKID,UJTARTALOM,MODOSITASDATUM) values (50,42,'polgi2',to_date('03-MAY-25','DD-MON-RR'));
Insert into SYSTEM.SZOCIKK_UPDATED (ID,SZOCIKKID,UJTARTALOM,MODOSITASDATUM) values (61,4,'A triggerek használata Oracle adatbázisban.',to_date('04-MAY-25','DD-MON-RR'));
Insert into SYSTEM.SZOCIKK_UPDATED (ID,SZOCIKKID,UJTARTALOM,MODOSITASDATUM) values (62,84,'magyar tartalom',to_date('04-MAY-25','DD-MON-RR'));
Insert into SYSTEM.SZOCIKK_UPDATED (ID,SZOCIKKID,UJTARTALOM,MODOSITASDATUM) values (81,84,'magyar tartalom2',to_date('05-MAY-25','DD-MON-RR'));
REM INSERTING into SYSTEM.TEMAKOR
SET DEFINE OFF;
Insert into SYSTEM.TEMAKOR (ID,NEV,SZULO_TEMA_ID) values (1,'Természet',null);
Insert into SYSTEM.TEMAKOR (ID,NEV,SZULO_TEMA_ID) values (2,'Technológia',null);
Insert into SYSTEM.TEMAKOR (ID,NEV,SZULO_TEMA_ID) values (3,'Történelem',null);
Insert into SYSTEM.TEMAKOR (ID,NEV,SZULO_TEMA_ID) values (4,'Művészet',3);
Insert into SYSTEM.TEMAKOR (ID,NEV,SZULO_TEMA_ID) values (5,'Fizika',1);
Insert into SYSTEM.TEMAKOR (ID,NEV,SZULO_TEMA_ID) values (21,'Témakör',null);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PK_SZOCIKKTEMAKOR
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_SZOCIKKTEMAKOR" ON "SYSTEM"."SZOCIKKTEMAKOR" ("SZOCIKK_ID", "TEMAKOR_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Constraints for Table SZOCIKK
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."SZOCIKK" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SZOCIKK" MODIFY ("CIM" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SZOCIKK" MODIFY ("LETREHOZAS_DATUM" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SZOCIKK" MODIFY ("MODOSITAS_DATUM" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SZOCIKK" MODIFY ("STATUSZ" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SZOCIKK" MODIFY ("SZERZO_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SZOCIKK" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."SZOCIKK" MODIFY ("NYELV" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."HIBA" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."HIBA" MODIFY ("JELENTESI_DATUM" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."HIBA" MODIFY ("STATUSZ" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."HIBA" MODIFY ("FELHASZNALO_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."HIBA" MODIFY ("SZOCIKK_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."HIBA" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
--  Constraints for Table SZOCIKKKATEGORIA
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."SZOCIKKKATEGORIA" MODIFY ("SZOCIKK_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SZOCIKKKATEGORIA" MODIFY ("KATEGORIA_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SZOCIKKKATEGORIA" ADD PRIMARY KEY ("SZOCIKK_ID", "KATEGORIA_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."TEMAKOR" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TEMAKOR" MODIFY ("NEV" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TEMAKOR" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
--  Constraints for Table SZOCIKKTEMAKOR
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."SZOCIKKTEMAKOR" MODIFY ("SZOCIKK_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SZOCIKKTEMAKOR" MODIFY ("TEMAKOR_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SZOCIKKTEMAKOR" ADD CONSTRAINT "PK_SZOCIKKTEMAKOR" PRIMARY KEY ("SZOCIKK_ID", "TEMAKOR_ID")
  USING INDEX "SYSTEM"."PK_SZOCIKKTEMAKOR"  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table SZOCIKKLEKTOR
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."SZOCIKKLEKTOR" MODIFY ("SZOCIKK_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SZOCIKKLEKTOR" MODIFY ("LEKTOR_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SZOCIKKLEKTOR" ADD PRIMARY KEY ("SZOCIKK_ID", "LEKTOR_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
--  Constraints for Table SZOCIKKKULCSSZO
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."SZOCIKKKULCSSZO" MODIFY ("SZOCIKK_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SZOCIKKKULCSSZO" MODIFY ("KULCSSZO_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SZOCIKKKULCSSZO" ADD PRIMARY KEY ("SZOCIKK_ID", "KULCSSZO_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."KULCSSZO" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."KULCSSZO" MODIFY ("SZO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."KULCSSZO" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."KATEGORIA" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."KATEGORIA" MODIFY ("NEV" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."KATEGORIA" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."FELHASZNALO" MODIFY ("ID" NOT NULL ENABLE);
  ...
  ALTER TABLE "SYSTEM"."FELHASZNALO" MODIFY ("REGISZTRACIOS_DATUM" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FELHASZNALO" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."FELHASZNALO" ADD UNIQUE ("EMAIL")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."LEKTOR" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."LEKTOR" MODIFY ("TUDOMANYOS_FOKOZAT" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."LEKTOR" MODIFY ("INTEZET" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."LEKTOR" MODIFY ("SZAKTERULET" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."LEKTOR" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."HIBA" ADD CONSTRAINT "FK_HIBA_FELHASZNALO" FOREIGN KEY ("FELHASZNALO_ID")
	  REFERENCES "SYSTEM"."FELHASZNALO" ("ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "SYSTEM"."HIBA" ADD CONSTRAINT "FK_HIBA_SZOCIKK" FOREIGN KEY ("SZOCIKK_ID")
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."SZOCIKKLEKTOR" ADD CONSTRAINT "FK_SZOCIKK_LEKTOR_SZOCIKK" FOREIGN KEY ("SZOCIKK_ID")
	  REFERENCES "SYSTEM"."SZOCIKK" ("ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table SZOCIKKTEMAKOR
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."SZOCIKKTEMAKOR" ADD CONSTRAINT "FK_SZOCIKKTEMAKOR_SZOCIKK" FOREIGN KEY ("SZOCIKK_ID")
	  REFERENCES "SYSTEM"."SZOCIKK" ("ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "SYSTEM"."SZOCIKKTEMAKOR" ADD CONSTRAINT "FK_SZOCIKKTEMAKOR_TEMAKOR" FOREIGN KEY ("TEMAKOR_ID")
