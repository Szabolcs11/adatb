...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SYSTEM"."SZOCIKK_UPDATED_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 81 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into SYSTEM.HIBA (ID,JELENTESI_DATUM,STATUSZ,FELHASZNALO_ID,SZOCIKK_ID) values (1,to_date('23-MAR-25','DD-MON-RR'),'Nyitott',1,1);
...
Insert into SYSTEM.SZOCIKK (ID,CIM,LETREHOZAS_DATUM,MODOSITAS_DATUM,STATUSZ,SZERZO_ID,TARTALOM,NYELV) values (84,'Új magyar szócikk',to_date('04-MAY-25','DD-MON-RR'),to_date('04-MAY-25','DD-MON-RR'),'Lektorálásra vár',1,'magyar tartalom','magyar');
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."HIBA" MODIFY ("SZOVEG" NOT NULL ENABLE);
