...
SET DEFINE OFF;
Insert into SYSTEM.LEKTORNYELV (LEKTOR_ID,NYELV_ID,SZINT) values (1,1,'Anyanyelvi');
Insert into SYSTEM.LEKTORNYELV (LEKTOR_ID,NYELV_ID,SZINT) values (2,2,'Haladó');
Insert into SYSTEM.LEKTORNYELV (LEKTOR_ID,NYELV_ID,SZINT) values (3,3,'Középhaladó');
Insert into SYSTEM.LEKTORNYELV (LEKTOR_ID,NYELV_ID,SZINT) values (4,4,'Haladó');
Insert into SYSTEM.LEKTORNYELV (LEKTOR_ID,NYELV_ID,SZINT) values (5,5,'Anyanyelvi');
...
SET DEFINE OFF;
Insert into SYSTEM.SZOCIKK (ID,CIM,LETREHOZAS_DATUM,MODOSITAS_DATUM,STATUSZ,SZERZO_ID,TARTALOM) values (1,'SQL Alapok',to_date('23-MAR-25','DD-MON-RR'),to_date('23-MAR-25','DD-MON-RR'),'Aktív',1,'Bevezetes az SQL vilagaba.');
Insert into SYSTEM.SZOCIKK (ID,CIM,LETREHOZAS_DATUM,MODOSITAS_DATUM,STATUSZ,SZERZO_ID,TARTALOM) values (2,'Adatbázis Normalizálás',to_date('23-MAR-25','DD-MON-RR'),to_date('23-MAR-25','DD-MON-RR'),'Aktív',2,'Az adatbázis normalizálás szintjei.');
Insert into SYSTEM.SZOCIKK (ID,CIM,LETREHOZAS_DATUM,MODOSITAS_DATUM,STATUSZ,SZERZO_ID,TARTALOM) values (3,'Indexelés',to_date('23-MAR-25','DD-MON-RR'),to_date('23-MAR-25','DD-MON-RR'),'Szerkesztés alatt',3,'Hogyan gyorsíthatók le a lekérdezések indexekkel?');
Insert into SYSTEM.SZOCIKK (ID,CIM,LETREHOZAS_DATUM,MODOSITAS_DATUM,STATUSZ,SZERZO_ID,TARTALOM) values (4,'Oracle Triggerek',to_date('23-MAR-25','DD-MON-RR'),to_date('23-MAR-25','DD-MON-RR'),'Aktív',4,'A triggerek használata Oracle adatbázisban.');
Insert into SYSTEM.SZOCIKK (ID,CIM,LETREHOZAS_DATUM,MODOSITAS_DATUM,STATUSZ,SZERZO_ID,TARTALOM) values (5,'Tárolt Eljárások',to_date('23-MAR-25','DD-MON-RR'),to_date('23-MAR-25','DD-MON-RR'),'Aktív',5,'A PL/SQL tárolt eljárások bemutatása.');
Insert into SYSTEM.SZOCIKK (ID,CIM,LETREHOZAS_DATUM,MODOSITAS_DATUM,STATUSZ,SZERZO_ID,TARTALOM) values (21,'Tudomány és Technológia',to_date('26-APR-25','DD-MON-RR'),to_date('26-APR-25','DD-MON-RR'),'Elfogadva',1,'Ez egy cikk a technológiai fejlődésről.');
Insert into SYSTEM.SZOCIKK (ID,CIM,LETREHOZAS_DATUM,MODOSITAS_DATUM,STATUSZ,SZERZO_ID,TARTALOM) values (22,'Művészet és Kultúra',to_date('26-APR-25','DD-MON-RR'),to_date('26-APR-25','DD-MON-RR'),'Beküldve',2,'A művészet hatása a társadalomra.');
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."LEKTORNYELV" MODIFY ("NYELV_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."LEKTORNYELV" MODIFY ("SZINT" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."LEKTORNYELV" ADD PRIMARY KEY ("LEKTOR_ID", "NYELV_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
